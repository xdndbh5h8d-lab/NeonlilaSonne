...
<br> {% if posts.size > 0 %}
<br> <h2 id="{{ cat }}">{{ cat | replace: "kunst", "🎨 Kunst & Ästhetik" | replace: "rituale", "📜 Rituale & Praxis" | replace: "wissenschaft", "🧠 Psychologie & Wissenschaft" | replace: "journal", "📖 Journal & Strategien" }}
</h2><br> 
